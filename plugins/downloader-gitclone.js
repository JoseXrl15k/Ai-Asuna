...
let handler = async (m, { args, usedPrefix, command }) => {
  ...
  try {
    ...
    let txt = `*乂  G I T H U B  -  D O W N L O A D*\n\n`
       txt += `	♢˚₊· ͟͟͞͞🌹  *Nombre* : ${filename}\n`
       txt += `	♢˚₊· ͟͟͞͞🌹  *Repositorio* : ${user}/${sanitizedRepo}\n`
       txt += `	♢˚₊· ͟͟͞͞🌹  *Creador* : ${repoData.owner.login}\n`
       txt += `	♢˚₊· ͟͟͞͞🌹  *Descripción* : ${repoData.description || 'Sin descripción disponible'}\n`
       txt += `	♢˚₊· ͟͟͞͞🌹  *Url* : ${args[0]}\n\n`
       txt += `🚩 *${textbot}*`
