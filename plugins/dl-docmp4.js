...
await m.react('✅')
await star.sendMessage(m.chat, { document: { url: dl_url }, caption: '*By: Asuna*', mimetype: 'video/mp4', fileName: `${title}` + `.mp4`}, {quoted: fkontak })
} catch {
await m.react('🕒')
try {
...
await star.sendMessage(m.chat, { document: { url: dl_url }, caption: '*By: AsunaBot*', mimetype: 'video/mp4', fileName: `${title}` + `.mp4`}, {quoted: fkontak })
await m.react('✅')
} catch {
await m.react('🕒')
try {
