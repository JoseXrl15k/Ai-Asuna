...
if (!fs.existsSync("./AsunaJadiBot/" + authFolderB)) {
fs.mkdirSync("./AsunaJadiBot/" + authFolderB, { recursive: true });
}
if (args[0]) {
fs.writeFileSync(`AsunaJadiBot/creds.json`, Buffer.from(args[0], 'base64').toString('utf-8'))
}
const { state, saveState, saveCreds } = await useMultiFileAuthState(`./AsunaJadiBot/${authFolderB}`);
