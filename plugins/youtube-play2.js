...
let txt = '`乂  Y O U T U B E  -  P L A Y`\n\n'
	txt += `	♢˚₊· ͟͟͞͞🌹   *Título* : ${vid.title}\n`
	txt += `	♢˚₊· ͟͟͞͞🌹   *Duración* : ${vid.timestamp}\n`
	txt += `	♢˚₊· ͟͟͞͞🌹   *Visitas* : ${toNum(vid.views)} ( *${formatNumber(vid.views)}* )\n`
	txt += `	♢˚₊· ͟͟͞͞🌹   *Autor* : ${vid.author.name}\n`
	txt += `	♢˚₊· ͟͟͞͞🌹   *Publicado* : ${eYear(vid.ago)}\n`
	txt += `	♢˚₊· ͟͟͞͞🌹   *Url* : ${'https://youtu.be/' + vid.videoId}\n\n`
