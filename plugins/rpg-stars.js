...
let handler = async (m, {conn, usedPrefix}) => {
    ...
    let txt = ` –  *S T A R S  -  U S E R*\n\n`
        txt += `┌  ♢˚₊· ͟͟͞͞🌹  *Nombre* : ${user.name}\n`
        txt += `│  ♢˚₊· ͟͟͞͞🌹  *Diamantes* : ${toNum(user.limit)} ( *${user.limit}* )\n`
        txt += `│  ♢˚₊· ͟͟͞͞🌹  *Bank* : ${toNum(user.bank)} ( *${user.bank}* )\n`
        txt += `└  ♢˚₊· ͟͟͞͞🌹  *XP* : ${toNum(user.exp)} ( *${user.exp}* )`
...
handler.tags = ['rpg']
handler.command = ['coins', 'wallet', 'cartera', 'diamantes', 'stars', 'bal', 'balance']
