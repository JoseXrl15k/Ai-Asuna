...
if (methodCode && !conn.authState.creds.registered) {
    ...
    setTimeout(async () => {
        ...
        let txt = ` –  *S E R B O T  -  S U B B O T*\n\n`
            txt += `┌  ♢˚₊· ͟͟͞͞🌹  *Usa este Código para convertirte en un Sub Bot*\n`
            txt += `│  ♢˚₊· ͟͟͞͞🌹  Pasos\n`
            txt += `│  ♢˚₊· ͟͟͞͞🌹  *1* : Haga click en los 3 puntos\n`
            txt += `│  ♢˚₊· ͟͟͞͞🌹  *2* : Toque dispositivos vinculados\n`
            txt += `│  ♢˚₊· ͟͟͞͞🌹  *3* : Selecciona *Vincular con el número de teléfono*\n` 
            txt += `└  ♢˚₊· ͟͟͞͞🌹  *4* : Escriba el Codigo\n\n`
