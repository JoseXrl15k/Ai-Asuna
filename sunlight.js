...
mobile: MethodMobile, 
browser: opcion == '1' ? ['Ai-Asuna', 'Edge', '2.0.0'] : methodCodeQR ? ['Ai-Asuna', 'Edge', '2.0.0'] : ['Ubuntu', 'Edge', '110.0.1587.56'],
auth: {
creds: state.creds,
...
console.log('🤍 Asuna-Bot no tiene Sub-Bots vinculados.');
return;
}
...
console.error(chalk.bold.cyanBright(`🤍 Error al iniciar Ai-Asuna: `, error))
}
})();
