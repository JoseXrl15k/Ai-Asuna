...
//• ↳ ◜𝑴𝑨𝑹𝑪𝑨𝑺 𝑫𝑬 𝑨𝑮𝑼𝑨◞ • 🐢
global.packname = 'ᴀʂυɳα уυυƙι Ⴆσт 🌸'
global.author = 'J\no\ns\ne\n\nX\nr\nl\n'
global.wm = '⌬ мσ∂ιϝιҽ∂ ρσωєяєԃ χɾʅ 🌵'
global.titulowm = 'イ᨟᪽᪵᪰ᨅ Asu᪾᪹᪻᪾᪲na Yuu᪶᪱᪼ki 🌹᪺᪽᪼᪲᪼'
global.titulowm2 = ''
global.igfg = '@xrljose'
global.botname = '© ᴀι ᴀѕυиα ʏυυƙι'
global.dev = 'イ Ẫ𝚂uɴᴀ Ŷůůḵɪ ꢄิᝠ'
global.textbot = '{\n "bot": {\n   "name": "Aι αѕυиα",\n     "author": "Jose Xrl",\n   "status_bot": "active"\n }\n}'
global.titu = 'ᴀʂυɳα уυυкι Ⴆσт...'
global.vs = '2.1.0'
...
//• ↳ ◜𝑭𝑨𝑲𝑬 𝑬𝑺𝑻𝑰𝑳𝑶◞ • 🪩 🌸
global.estilo = { key: {  fromMe: false, participant: `0@s.whatsapp.net`, ...(false ? { remoteJid: "5219992095479-1625305606@g.us" } : {}) }, message: { orderMessage: { itemCount : -999999, status: 1, surface : 1, message: 'Aѕυиα уυυƙι', orderTitle: 'packname', thumbnail: logo7, sellerJid: '0@s.whatsapp.net'}}}

global.fakegif2 = { key: { participant: `0@s.whatsapp.net`, ...(false ? { remoteJid: "5219992095479-1625305606@g.us" } : {}) }, message: { videoMessage: { title: 'Aʂυɳα уυυкι', h: `Hmm`, seconds: '99999', gifPlayback: true, caption: '• Bɪᴇɴʙᴇɴɪᴅᴏ 👤', jpegThumbnail: logo7 }}};

global.fakegif3 = { key: { participant: `0@s.whatsapp.net`, ...(false ? { remoteJid: "5219992095479-1625305606@g.us" } : {}) }, message: { videoMessage: { title: 'Aѕυиα ყυυкι', h: `Hmm`, seconds: '99999', gifPlayback: true, caption: 'Asᴜɴᴀ Yᴜᴜᴋɪ', jpegThumbnail: logo8 }}};

global.fakegif4 = { key: { participant: `0@s.whatsapp.net`, ...(false ? { remoteJid: "5219992095479-1625305606@g.us" } : {}) }, message: { videoMessage: { title: 'Aѕυиα-ყυυƙι', h: `Hmm`, seconds: '99999', gifPlayback: true, caption: 'Sticker Asuna ｡^‿^｡ 🐢', jpegThumbnail: logo8 }}};

global.estilox = { key: {  fromMe: false, participant: `0@s.whatsapp.net`, ...(false ? { remoteJid: "5219992095479-1625305606@g.us" } : {}) }, message: { orderMessage: { itemCount : -999999, status: 1, surface : 1, message: 'Aʂυɳα_уυυкι', orderTitle: 'packname', thumbnail: logo7, sellerJid: '0@s.whatsapp.net'}}}
...
global.md = 'https://github.com/JoseXrl15k/Ai-Asuna' //Github Oficial
